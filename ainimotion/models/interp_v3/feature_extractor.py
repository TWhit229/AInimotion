...
v3: Configurable correlation displacement (default d=6, 169 channels).
"""
...
class FeaturePyramid(nn.Module):
    ...
    v3: Configurable max_displacement for wider correlation search.
    
    Args:
        in_channels: Input image channels (default 3 for RGB)
        base_channels: Base feature channels (doubled at each level)
        max_displacement: Maximum displacement for correlation volume
    """
    ...
    def __init__(
        ...
        self.lateral1 = nn.Conv2d(c * 2, c * 4, 1)
        self.lateral0 = nn.Conv2d(c, c * 4, 1)
    ...
    def corr_channels(self) -> int:
        """Number of correlation volume channels: (2*d+1)²."""
    ...
    def _compute_correlation(
        ...
        v3: Uses configurable max_displacement (default 6).
