...
$InputFile = "D:\Projects\Training\No Sub\[Judas] Kimi no Na Wa. (Your Name.) [BD 2160p 4K UHD][HEVC x265 10bit][Dual-Audio][Multi-Subs].mkv"
...
# Using E:\Temp for temp storage to avoid C: drive space issues
